...
public class RegisterSteps {
    ...
    public void user_in_the_register_page(){
        System.setProperty("webdriver.chrome.driver","/Users/shahnazpervin/Desktop/Tahsan/eBayBDD/eBayCucumber/driver/chromedriver");
    ...
    public void put_first_name() throws Throwable {
        driver.findElement(By.id("firstname")).sendKeys("Tahsan");
